                    ...
                    <div className="row">
                        <div className="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
                            ...
                            <ul className="navbar-nav flex-column mt-4">
                                <li className="nav-item"><Link to="/sub_registrar/dashboard" className="nav-link text-white p-1 mb-2 sidebar-link"><small><i className="fas fa-home text-light fa-sm mr-3"></i>Dashboard</small></Link></li>
                                ...
                                <li className="nav-item"><Link to="/sub_registrar/register" className="nav-link text-white p-1 mb-2 sidebar-link"><small><i className="fas fa-envelope text-light fa-sm mr-3"></i>Register Students</small></Link></li>
