                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
                            <div className="bottom-border p-3 mt-3">
                                ...
                                <div className="info my-3 text-center">
                                   <img src="images/logo.png" width="50" className="rounded-circle mr-3"  /> 
                                    <Link to="#" className="text-white text-uppercase text-center">Sub Registrar</Link>
                                    <p className="text-center text-white custom-small">SPSU</p>
                                </div>
                            </div>
                            <ul className="navbar-nav flex-column mt-4">
                                ...
                                <li className="nav-item"><Link to="students" className="nav-link text-white p-1 mb-2 sidebar-link"><small><i className="fas fa-user text-light fa-sm mr-3"></i>Students</small></Link></li>
                                ...
                                <li className="nav-item"><Link to="departments" className="nav-link text-white p-1 mb-2 sidebar-link"><small><i className="fas fa-shopping-cart text-light fa-sm mr-3"></i>Departments</small></Link></li>
